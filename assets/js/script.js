...
for (var i = 0; i < countries.length; i++) {
  ele.innerHTML = ele.innerHTML +
      '<option value="' + countries[i]['dial_code'] + '">' + countries[i]['name'] + '</option>';
}
...
function change(ele) {
  document.getElementById('num1').value = ele.value;
}

function setdef(concode){
var ele = document.getElementById('cont');
var num1 = document.getElementById("num1");
for(var i=0;i<countries.length;i++){
  if (concode==countries[i]['code']){
    ele.innerHTML = ele.innerHTML +
    '<option selected="selected" value="' + countries[i]['dial_code'] + '">' + countries[i]['name'] + '</option>';
    num1.value = countries[i]['dial_code'];
  }
}
}
